/* map2D_B.c - 2D rectangular, cylindrical symmetric field map 
...
void map2D_B_init(gptinit *init)
{
  ...
  if( numc!=6 )
    gpterror( "Syntax: %s(ECS,mapfile.gdf,r,z,Br,Bz,Bfac)\n", gptgetname(init) ) ;
