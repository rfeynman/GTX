...
main(int argc, char ** argv)
{
	...
	while(1)
	{
		...
		printf("null  "); dogleg_sim( X*0.001+delta0, Y*0.001+delta0, Z*0.001+delta0, bx000, by000, bz000);

		printf("m00   "); dogleg_sim( X*0.001+deltam, Y*0.001+delta0, Z*0.001+delta0, bxm00, bym00, bzm00);
		printf("p00   "); dogleg_sim( X*0.001+deltap, Y*0.001+delta0, Z*0.001+delta0, bxp00, byp00, bzp00);

		printf("0m0   "); dogleg_sim( X*0.001+delta0, Y*0.001+deltam, Z*0.001+delta0, bx0m0, by0m0, bz0m0);
		printf("0p0   "); dogleg_sim( X*0.001+delta0, Y*0.001+deltap, Z*0.001+delta0, bx0p0, by0p0, bz0p0);

		printf("00m   "); dogleg_sim( X*0.001+delta0, Y*0.001+delta0, Z*0.001+deltam, bx00m, by00m, bz00m);
		printf("00p   "); dogleg_sim( X*0.001+delta0, Y*0.001+delta0, Z*0.001+deltap, bx00p, by00p, bz00p);
